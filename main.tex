...
\begin{columns}
    ...
    \block{An ILNP Overlay Network}{
        ...
        \end{itemize}
        \includestandalone[width=\linewidth]{diagrams/overlay_network_stack.tex}\\
    }
    ...
    \block{Discovery Protocol Example}{
        ...
        \end{itemize}
        \includestandalone[width=\linewidth]{diagrams/discovery_protocol_topology.tex}\\
        \includestandalone[width=\linewidth]{diagrams/discovery_protocol_sequence_diagram.tex}\\
    }
    ...
    \block{Locator Update Protocol Example}{
        ...
        \end{itemize}
        \includestandalone[width=\linewidth]{diagrams/locator_update_topology.tex}\\
        \includestandalone[width=\linewidth]{diagrams/locator_update_sequence_diagram.tex}\\
    }
\end{columns}
...
\begin{columns}
    ...
    \block{Experiment Setup}
    {
        ...
        \includestandalone[width=\linewidth]{diagrams/experiment.tex}\\
    }
